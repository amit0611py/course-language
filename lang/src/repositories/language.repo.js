...
// All raw SQL for the languages table lives here.
// Services call these functions; no SQL leaks into service or route layers.
...
const upsert = async (db, lang) => {
  const { rows } = await db.query(`
    INSERT INTO languages (slug, name, icon_url, description, meta, sort_order)
